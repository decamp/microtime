 ...
 * </p><p>
 * WordLayout.createStretch() - Causes previously placed component to be stretched or shrunk 
...
public class WordLayout implements LayoutManager{
    ...
    public synchronized void setMargins(int hm, int vm) {
        mHMargin = hm;
        mVMargin = vm;
    }
    ...
    public synchronized void layoutContainer(Container cont) {
        ...
        int indent = mHMargin;
        int maxHeight = 0;
        final int maxWidth = availableWidth - mHMargin;
        ...
        if(column > 0){
            mListHeight = y + maxHeight + mVMargin;
        }else{
            mListHeight = y;
        }	
    }
